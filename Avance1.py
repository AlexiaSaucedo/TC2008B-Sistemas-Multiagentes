...
#Función para crear un camino al azar desde un nodo inicial
...
#Funcion para actualizar el cronómetro de los semáforos y cambiar su estado
...
class MyModel(ap.Model):
    ...
    def step(self):
        actualizarSemaforos(self.p['second_per_step'])
        self.agents.movimiento(self.t*self.p['second_per_step'])
        plt.show()
